...
public class ElectronicProduct extends Product {
    ...
    public String toString() {
        //return super.getCode() + "," + super.getName() + "," + super.getManufacturer() + "," + super.getPrice() + "," + guaranty + ", voltage=" + voltage + ", power=" + power;
        return super.toString() + "," + guaranty + ", voltage=" + voltage + ", power=" + power;
    }
